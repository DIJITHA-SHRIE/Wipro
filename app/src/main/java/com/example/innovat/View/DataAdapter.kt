...
class DataViewHolder constructor(itemView: View, binding: AdapterLayBinding) :
    ...
    fun bind(title: String?, description: String?, imageHref: String?, context: Context) {
        ...
        val options =
            RequestOptions().placeholder(R.drawable.innovatepic).error(R.drawable.innovatepic);
